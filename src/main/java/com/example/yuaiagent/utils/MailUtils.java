package com.example.yuaiagent.utils;
...
public class MailUtils {
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "1444065399@qq.com"; // 这个是普通QQ邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "fqzqknebtlcefeeb";
    ...
    public static boolean sendEmail(Set<String> emails, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "测试发送邮件", "UTF-8"));
